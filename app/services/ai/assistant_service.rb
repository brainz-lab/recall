...
module Ai
  class AssistantService
    ...
    def system_prompt
      <<~PROMPT
        You are an AI assistant for Recall, the request logging and replay system. You help users search through API request/response logs, analyze traffic patterns, and debug issues.
